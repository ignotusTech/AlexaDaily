...
msgData[1.14] = 'Dia Internacional da Pipa e Dia do Enfermo.';
...
msgData[4.1] = 'Dia da Abolição da Escravidão dos Índios (1680) e Dia da Mentira';
msgData[4.2] = 'Dia do Propagandista, Dia Internacional do Livro Infantil e Dia Mundial de Conscientização do Autismo';
msgData[4.3] = 'Dia do Atuário e Dia do Desporto Comunitário';
msgData[4.4] = 'Dia Nacional do Parkinsoniano';
msgData[4.5] = 'Dia das Telecomunicações, Dia do Propagandista Farmacêutico e Dia dos Fabricantes de Materiais de Construção';
msgData[4.6] = 'Dia Nacional de Mobilização pela Promoção da Saúde e Qualidade de Vida';
msgData[4.7] = 'Dia do Corretor, Dia do Jornalismo, Dia do Médico Legista e Dia Mundial da Saúde';
msgData[4.8] = 'Dia da Natação, Dia do Correio e Dia Mundial do Combate ao Câncer';
msgData[4.9] = 'Dia Nacional do Aço';
msgData[4.10] = 'Dia da Engenharia';
msgData[4.11] = 'Dia do Infectologista';
msgData[4.12] = 'Dia do Obstetra';
msgData[4.13] = 'Dia do Hino Nacional (1º Execução do Hino Nacional Brasileiro -1831), Dia do Office-Boy e Dia dos Jovens';
msgData[4.14] = 'Dia Pan-Americano';
msgData[4.15] = 'Dia da Conservação do Solo, Dia do Desarmamento Infantil e Dia Mundial do Desenhista';
msgData[4.16] = 'Dia da Voz';
msgData[4.17] = 'Dia do Lojista de CD e Dia Internacional de Luta dos Trabalhadores do Campo';
msgData[4.18] = 'Dia de Monteiro Lobato e Dia Nacional do Livro Infantil';
msgData[4.19] = 'Dia do Exército Brasileiro e Dia do Índio';
msgData[4.20] = 'Dia do Diplomata e Dia do Disco';
msgData[4.21] = 'Tiradentes, Dia da Latinidade, Dia do Metalúrgico, Dia do Policial Civil e Dia do Policial Militar';
msgData[4.22] = 'Descobrimento do Brasil (1500), Dia da Comunidade Luso-brasileira e Dia do Planeta Terra';
msgData[4.23] = 'Dia de São Jorge, Dia Mundial do Escoteiro, Dia Mundial do Livro e do Direito do Autor e Dia Nacional da Educação de Surdos';
msgData[4.24] = 'Dia do Agente de Viagem e Dia Internacional do Jovem Trabalhador';
msgData[4.25] = 'Dia Mundial da Malária e Dia da Contabilidade';
msgData[4.26] = 'Dia Internacional em Memória do Desastre de Chernobyl, Dia Mundial da Propriedade Intelectual, Dia da 1ª Missa no Brasil E Dia do Goleiro';
msgData[4.27] = 'Dia da Empregada Doméstica e Dia do Sacerdote';
msgData[4.28] = 'Dia Mundial da Segurança e Saúde no Trabalho, Dia da Sogra e Dia Internacional da Educação';
msgData[4.29] = 'Dia Internacional da Dança';
msgData[4.30] = 'Dia Internacional do Jazz, Dia do Ferroviário e Dia Nacional da Mulher';
msgData[5.1] = 'Dia da Literatura Brasileira e Dia Mundial do Trabalho';
msgData[5.2] = 'Dia Mundial do Atum, Dia do Taquígrafo e Dia Nacional do Ex-combatente';
msgData[5.3] = 'Dia Mundial da Liberdade de Imprensa, Assinatura da Ata de Constituição do Museu de Arte Moderna RJ (1948), Dia do Sertanejo e Dia Mundial da Liberdade de Imprensa';
msgData[5.4] = 'Dia do Calculista Estrutural';
msgData[5.5] = 'Dia da Comunidade, Dia do Artista Pintor, Dia do Marechal Rondon e Dia Nacional do Expedicionário';
msgData[5.6] = 'Dia do Cartógrafo';
msgData[5.7] = 'Dia do Oftalmologista e Dia do Silêncio';
msgData[5.8] = 'Tempo de Recordação e Reconciliação pelos que perderam a vida durante a Segunda Guerra Mundial, Dia do Profissional Marketing, Dia da Vitória, Dia do Artista Plástico e Dia Internacional da Cruz Vermelha';
msgData[5.9] = 'Dia da Europa';
msgData[5.10] = 'Dia da Cavalaria e Dia do Campo';
msgData[5.11] = 'Dia Mundial das Aves Migratórias e Dia da Integração do Telégrafo no Brasil';
msgData[5.12] = 'Dia Mundial do Enfermeiro';
msgData[5.13] = 'Abolição da Escravatura (1888), Dia da Fraternidade Brasileira, Dia do Automóvel e Dia do Zootecnista';
msgData[5.14] = 'Dia Continental do Seguro';
msgData[5.15] = 'Dia Internacional das Famílias, Dia do Assistente Social e Dia do Gerente Bancário';
msgData[5.16] = 'Dia Internacional da Luz e Dia do Gari';
msgData[5.17] = 'Dia Internacional da Comunicação e das Telecomunicações, Dia da Constituição e Dia Internacional contra a Homofobia';
msgData[5.18] = 'Dia dos Vidreiros, Dia Internacional dos Museus e Dia Nacional de Enfrentamento ao Abuso e à Exploração Sexual de Crianças e Adolescentes';
msgData[5.19] = 'Dia dos Acadêmicos do Direito e Dia Nacional de Combate à Cefaléia';
msgData[5.20] = 'Dia Mundial da Abelha, Ascensão do Senhor e Dia do Comissário de Menores';
msgData[5.21] = 'Dia Mundial da Diversidade Cultural para o Diálogo e o Desenvolvimento e Dia da Língua Nacional';
msgData[5.22] = 'Dia do Apicultor e Dia internacional da Biodiversidad';
msgData[5.23] = 'Dia da Juventude Constitucionalista';
msgData[5.24] = 'Dia da Infantaria, Dia do Datilógrafo, Dia do Detento, Dia do Telegrafista e Dia do Vestibulando';
msgData[5.25] = 'Dia da Indústria, Dia do Massagista e Dia do Trabalhador Rural';
msgData[5.26] = 'Dia Nacional do Bombeiro';
msgData[5.27] = 'Dia do Profissional Liberal';
msgData[5.28] = 'Dia Mundial do Hambúrguer e Assinatura do Decreto de 28 de maio de 1810 (teatro nacional)';
msgData[5.29] = 'Dia do Estatístico e Dia do Geógrafo';
msgData[5.30] = 'Dia das Bandeiras e Dia do Geólogo';
msgData[5.31] = 'Dia Mundial das Comunicações Sociais, Dia do Comissário de Bordo e Dia do Espírito San';
msgData[6.1] = 'Dia da Imprensa, Dia de Caxias, Primeira Transmissão de TV no Brasil e Semana Mundial do Meio Ambiente';
msgData[6.2] = '';
msgData[6.3] = 'Dia Mundial da Bicicleta, Dia de Pentecostes e Dia Mundial do Administrador de Pessoal';
msgData[6.4] = 'Dia Mundial das Crianças Vítimas de Agressão';
msgData[6.5] = 'Dia da Ecologia e Dia Mundial do Meio Ambiente';
msgData[6.6] = 'Dia de São Marcelino Champagnat (Fundador da Congregação dos Irmãos Maristas)';
msgData[6.7] = 'Dia Mundial da Segurança Alimentar e Dia da Liberdade de Imprensa';
msgData[6.8] = 'Corpus Christi, Dia Mundial dos Oceanos e Dia do Citricultor';
msgData[6.9] = 'Dia da Imunização, Dia do Porteiro, Dia do Tenista e Dia Nacional de Anchieta';
msgData[6.10] = 'Dia da Artilharia, Dia da Língua Portuguesa e Dia da Raça Portuguesa';
msgData[6.11] = 'Dia da Marinha Brasileira e Dia do Educador Sanitário';
msgData[6.12] = 'Dia Mundial Contra o Trabalho Infantil, Dia dos Namorados e Dia do Correio Aéreo Nacional';
msgData[6.13] = 'Dia Mundial de Consciencialização do Albinismo, Dia de Santo Antônio, Dia do Turista, Dia do Economista e Dia Mundial do Softball';
msgData[6.14] = 'Dia Mundial do Doador de Sangue, Dia do Solista e Dia Universal de Deus';
msgData[6.15] = 'Dia do Paleontólogo e Dia Mundial de Conscientização da Violência contra a Pessoa Idosa';
msgData[6.16] = 'Dia da Criança Africana';
msgData[6.17] = 'Dia Mundial de Combate à Desertificação e à Seca e Dia do Funcionário Público Aposentado';
msgData[6.18] = 'Dia do Químico e Imigração Japonesa';
msgData[6.19] = 'Dia do Cinema Brasileiro';
msgData[6.20] = 'Dia Mundial do Refugiado, Dia do Revendedor, Dia do Vigilante e Dia Internacional do Surf';
msgData[6.21] = 'Dia Internacional do Yoga, Dia da Mídia, Início do inverno e Dia Universal Olímpico';
msgData[6.22] = 'Dia do Aeroviário';
msgData[6.23] = '';
msgData[6.24] = 'Dia das Empresas Gráficas, Dia de São João e Dia Internacional do Leite';
msgData[6.25] = 'Dia Mundial do Marinheiro e Dia do Imigrante';
msgData[6.26] = 'Dia Internacional contra o Abuso e Tráfico Ilícito de Drogas, Dia Internacional de Apoio às Vítimas de Tortura e Dia do Meteorologista';
msgData[6.27] = 'Dia das Micro, Pequenas e Médias Empresas e Dia Nacional do Progresso';
msgData[6.28] = 'Dia da Renovação Espiritual e Dia Internacional do Orgulho LGBTQIAPN+';
msgData[6.29] = 'Dia da Telefonista, Dia de São Pedro e São Paulo, Dia do Papa e Dia do Pescador';
msgData[6.30] = 'Dia do Caminhoneiro';
msgData[7.1] = 'Dia da vacina BCG e Dia Internacional do Cooperativismo';
msgData[7.2] = 'Dia da Independência da Bahia, Dia do Bombeiro Brasileiro e Dia do Hospital';
msgData[7.3] = 'Dia Internacional das Cooperativas e Dia de São Tomé (Apóstolo)';
msgData[7.4] = 'Dia do Operador de Telemarketing e Independência dos EUA (1776)';
msgData[7.5] = 'Dia da Fundação do Exército da Salvação';
msgData[7.6] = 'Dia da Criação do IBGE';
msgData[7.7] = 'Dia Mundial do Chocolate e Dia do Ingresso das Mulheres nas Fileiras da Marinha';
msgData[7.8] = 'Dia do Panificador';
msgData[7.9] = 'Dia da Revolução e do Soldado Constitucionalista';
msgData[7.10] = 'Dia da Pizza';
msgData[7.11] = 'Dia Mundial da População';
msgData[7.12] = 'Dia do Engenheiro Florestal';
msgData[7.13] = 'Dia do Cantor, Dia do Engenheiro de Saneamento e Dia Mundial do Rock';
msgData[7.14] = 'Dia da Liberdade de Pensamento e Dia do Propagandista de Laboratório';
msgData[7.15] = 'Dia Nacional dos Clubes e Dia dos Homens';
msgData[7.16] = 'Dia do Comerciante';
msgData[7.17] = 'Dia de Proteção às Florestas';
msgData[7.18] = 'Dia Internacional de Nelson Mandela e Dia Nacional do Trovador';
msgData[7.19] = 'Dia da Caridade e Dia Nacional do Futebol';
msgData[7.20] = 'Dia do Amigo e Internacional da Amizade e Dia da 1ª Viagem à Lua (1969)';
msgData[7.21] = 'Dia dos Mortos da Marinha';
msgData[7.22] = 'Dia do Cantor Lírico e Dia do Trabalhador Doméstico';
msgData[7.23] = 'Dia do Guarda Rodoviário';
msgData[7.24] = '';
msgData[7.25] = 'Dia de São Cristóvão, Dia do Colono, Dia do Escritor e Dia do Motorista';
msgData[7.26] = 'Dia dos Avós';
msgData[7.27] = 'Dia do Motociclista';
msgData[7.28] = 'Dia do Agricultor';
msgData[7.29] = 'Dia da Identificação';
msgData[7.30] = 'Dia Mundial contra o Tráfico de Pessoas e Dia de São Pedro Crisólogo';
msgData[7.31] = 'Dia da Campanha do Quilo';
...
msgData[9.19] = 'Dia de São Geraldo e Dia do Teatro';
...
msgData[9.27] = 'Dia de Cosme e Damião, Dia do Encanador, Dia Mundial de Turismo e Dia Nacional do Idoso';
